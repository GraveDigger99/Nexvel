(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".worse__slider")) new core(".worse__slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            spaceBetween: 30,
        ...
        if (document.querySelector(".worse__slider-bottom")) new core(".worse__slider-bottom", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            speed: 6e3,
    ...
    stepperOpenButton.addEventListener("click", (e => {
        document.documentElement.classList.add("stepper-open");
        document.documentElement.classList.add("lock");
        firstActiveCard.classList.add("active");
        stepperStep.style.left = 0;
    ...
    multiStepForm.addEventListener("click", (e => {
        let incrementor;
        if (e.target.matches("[data-next]")) incrementor = 1; else return;
        if (null == incrementor) return;
